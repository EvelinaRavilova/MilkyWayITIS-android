package com.milkyway.flappybird.GameWorld;
...
import com.milkyway.flappybird.GameObjects.Bird;
import com.milkyway.flappybird.GameObjects.Grass;
import com.milkyway.flappybird.GameObjects.Pipe;
import com.milkyway.flappybird.GameObjects.ScrollHandler;
import com.milkyway.flappybird.TweenAccessors.Value;
import com.milkyway.flappybird.TweenAccessors.ValueAccessor;
import com.milkyway.flappybird.ZBHelpers.AssetLoader;
import com.milkyway.flappybird.ZBHelpers.InputHandler;
import com.milkyway.flappybird.ui.SimpleButton;
...
public class GameRenderer {
	...
	private TextureRegion bg, grass, birdMid, skullUp, skullDown, bar, ready,
			zbLogo, gameOver, highScore, scoreboard, star, noStar, retry, menu;
	...
	private void drawGrass() {
		...
		batcher.draw(grass, frontGrass.getX(), frontGrass.getY(),
				frontGrass.getWidth(), 50);
		batcher.draw(grass, backGrass.getX(), backGrass.getY(),
				backGrass.getWidth(), 50);
	}
	...
	private void drawMenuUI() {
		batcher.draw(zbLogo, 136 / 2 - 56, midPointY - 70,
				zbLogo.getRegionWidth() / 1.7f, zbLogo.getRegionHeight() / 1.7f);
	...
	private void drawMenu(){ batcher.draw(menu, 70,  midPointY + 40, 40, 18);}
	...
	private void drawReady() {
		batcher.draw(ready, 28, midPointY - 50, 88, 24);
	}
